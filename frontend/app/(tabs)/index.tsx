    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        <ScrollView showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); loadData(); }} tintColor={colors.brand} />} contentContainerStyle={s.scroll}>
          ...
          {/* Goals Quick Link */}
          <View style={[s.glassWrapper, { marginHorizontal: 20, marginBottom: 24 }]}>
            <BlurView intensity={theme === 'dark' ? 20 : 60} tint={theme === 'dark' ? 'dark' : 'light'} style={s.glassCard}>
              <TouchableOpacity 
                style={{ padding: 16, borderRadius: 16, borderWidth: 1, borderColor: colors.border, flexDirection: 'row', alignItems: 'center' }}
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ color: colors.textSecondary, fontSize: 13, fontFamily: fonts.regular, marginTop: 2 }}>Wujudkan rencana finansial Anda</Text>
                </View>
