      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
          <View style={s.headerSection}>
            ...
            <Text style={s.subtitle}>Kelola keuanganmu dengan cerdas</Text>
          </View>
          ...
          <View style={s.card}>
            ...
            <View style={s.inputRow}>
              ...
              <TextInput testID="login-email-input" style={s.input} placeholder="email@example.com"
            ...
            <View style={s.inputRow}>
              ...
              <TextInput testID="login-password-input" style={s.input} placeholder="Minimal 6 karakter"
            ...
            <TouchableOpacity testID="login-submit-button" style={[s.btn, loading && s.btnDisabled]} onPress={handleLogin} disabled={loading} activeOpacity={0.8}>
              {loading ? <ActivityIndicator color="#FFF" /> : <Text style={s.btnText}>Masuk</Text>}
            </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  footerLink: { fontSize: 14, fontWeight: '600', color: '#E86A33' },
});
